...
public class DIDLResource
{
    ...
    public String toXMLDescription(boolean showAll, Vector filterList, String absoluteServerPath)
    {
        ...
        if (importURI != null && importURI.length() > 0 && !importURI.toUpperCase().startsWith("HTTP://") && absoluteServerPath != null)
        {
        ...
        String result = "<res protocolInfo=\"" + protocolInfo + "\" " + (importURI != null ? "importUri=\"" + absoluteImportURI + "\" " : "")
    ...
    public boolean handleAttribute(String attribute, String value)
    {
        ...
        else if (attribute.equals(DIDLConstants.RES_IMPORT_URI))
        {
            setImportURI(value);
        }
        else if (attribute.equals(DIDLConstants.RES_SIZE))
        {
            setSize(value);
        }
        else if (attribute.equals(DIDLConstants.RES_DURATION))
        {
            setDuration(value);
        }
        else if (attribute.equals("bitrate"))
        {
            this.bitrate = value;
        }
        else if (attribute.equals("nrAudioChannels"))
        {
            nrAudioChannels = value;
        }
        else if (attribute.equals("sampleFrequency"))
        {
            this.sampleFrequency = value;
        }
        else if (attribute.equals("bitsPerSample"))
        {
